  ...
  return (
    <article className="rounded-[30px] border-4 border-[#41295a] bg-[#fffdf7] p-6 shadow-panel transition hover:-translate-y-1">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-[0.25em] text-[#111111]">Projeto</p>
      ...
      <div className="mt-6 flex items-center justify-between gap-4">
        ...
        <Link
          ...
          className="rounded-[18px] border-4 border-[#41295a] bg-[#111111] px-4 py-2 text-sm font-bold text-white shadow-sticker transition hover:-translate-y-0.5 hover:bg-[#000000]"
        >
          Abrir projeto
        </Link>
      </div>
