...
function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(255,226,154,0.45),_transparent_18%),radial-gradient(circle_at_top_right,_rgba(212,212,216,0.35),_transparent_24%),linear-gradient(180deg,_#fff9df_0%,_#f3f4f6_50%,_#e8f7ff_100%)] text-[#41295a]">
      <div className="mx-auto grid min-h-screen max-w-7xl lg:grid-cols-[280px_1fr]">
        <aside className="border-b-4 border-[#41295a] bg-[#fff3b3] p-6 lg:border-b-0 lg:border-r-4">
          <div className="mb-10">
            <span className="inline-flex rounded-full border-4 border-[#41295a] bg-[#fffdf7] px-4 py-2 text-xs font-bold uppercase tracking-[0.28em] text-[#111111] shadow-sticker">
              Mini Jira
            </span>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `block rounded-[24px] border-4 border-[#41295a] px-4 py-3 text-base font-bold transition ${
                  isActive
                    ? 'translate-x-1 bg-[#111111] text-white shadow-sticker'
          ...
          <div className="mt-10 rounded-[30px] border-4 border-[#41295a] bg-[#fffdf7] p-4 shadow-sticker">
            <p className="text-xs uppercase tracking-[0.2em] text-[#111111]">{'Sessão'}</p>
